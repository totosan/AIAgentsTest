...
public class MyRolePlayOrchestrator : IOrchestrator
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        while (candidates.Any())
        {
            ...
            // Remove the current candidate and retry
            candidates = candidates.Where(x => x.Name!.ToLower() != name.ToLower()).ToList();
        ...
        var errorMessage = $"There aren't any candidates to chose from.";
